        ...
        <form onSubmit={handleAddSubmit} className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div>
              ...
              <input type="number" name="discountPercentage" className="w-full px-4 py-3 border border-gray-200 rounded-xl focus:ring-2 focus:ring-blue-500 outline-none transition" placeholder="20" />
            </div>
          </div>
